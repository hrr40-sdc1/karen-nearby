...
"$LOCATION"/bin/neo4j-admin import --database=graph.db  --nodes="csvs/headers/cities-header.csv,csvs/archives/cities-data.*" --nodes="csvs/headers/listings-header.csv,csvs/archives/listings-data.*"
